...
| [aws_subnet.publica_3](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/subnet) | resource |
...
| <a name="input_subnet_publica_3_cidr"></a> [subnet\_publica\_3\_cidr](#input\_subnet\_publica\_3\_cidr) | CIDR de la tercera subred pública | `string` | n/a | yes |
| <a name="input_vpc_cidr"></a> [vpc\_cidr](#input\_vpc\_cidr) | CIDR block de la VPC | `string` | `"10.0.0.0/16"` | no |
